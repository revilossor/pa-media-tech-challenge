...
import { main } from '../../../src/create-item'
...
describe('When I invoke the create-item handler', () => {
  ...
  describe('And the event is valid', () => {
    beforeEach(async () => {
      ...
      mockItemRepo.create.mockResolvedValue([{ itemKey }])
    ...
    it('And the item is created in the item repository', () => {
